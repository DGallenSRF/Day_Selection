...
March_18_melt <- melt(March_18_dat,id.vars = c('Detector_ID','Metric','Date','Date_Posixct','filename'),variable.name = "Time",value.name = 'Volume')
...
March_18_melt_PM_Peak <- March_18_melt[hours(March_18_melt$Date_Time)%in%PM_Peak,]
