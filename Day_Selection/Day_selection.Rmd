...
```{r heatmap for subset,fig.width=11}

levels <- first(levels(March_18_melt_PM_Peak$Detector_ID),100)
...
matrix <- March_18_melt_PM_Peak %>%
  ...
  spread(Date_Posixct,SumVol)


vector <- as.character(matrix$Detector_ID)
matrix2 <- matrix[,-1] %>% as.data.frame()
